...
$s = $cnx->prepare($req);
$s->bindValue('annee', $annee, PDO::PARAM_INT);
$s->bindValue('nb', $nb, PDO::PARAM_INT);
// Ceci montre la différence entre bindParam et bindValue. En changeant la valeur ci-dessous celle-ci sera prise en compte par bindParam mais pas par bindValue$nb = 30;
$nb = 40;
$s->execute();
